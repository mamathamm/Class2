...
public class Register extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if(EditTextStatus){
                   if (password.getText().length()>=6){
                       ...
                       Toast.makeText(Register.this, "password must be 6 digits", Toast.LENGTH_SHORT).show();
                   }
    ...
    public void openloginactivity(){
        // Finishing current Register Activity.
        finish();
    ...
    public void openmainactivity(){
        ...
        // Opening the Register Activity using Intent.
